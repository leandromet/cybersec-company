...
const ServiceCard: React.FC<{
  ...
  return (
    <div
      onClick={onClick}
      className={`
        group relative cursor-pointer rounded-2xl md:rounded-3xl border-2 transition-all duration-300
        overflow-hidden shadow-lg hover:shadow-2xl w-full
        ${
          isActive
    ...
    >
      {/* Top Gradient Bar */}
      <div
        className={`absolute top-0 left-0 w-full h-2 rounded-t-2xl md:rounded-t-3xl ${
          isActive
      ...
      <h3
        className={`
        text-lg md:text-xl font-bold mb-1 md:mb-2 text-center transition-colors duration-300 px-2
        ${
          isActive
            ? "text-indigo-700"
      ...
      {/* Description */}
      <p className="text-gray-500 text-center px-2 md:px-4 mb-2 md:mb-4 text-xs md:text-sm min-h-[32px] md:min-h-[48px] leading-tight">
        {service.description}
      </p>

      {/* Features */}
      <div className="flex flex-wrap gap-1 md:gap-2 justify-center mb-2 md:mb-4 px-1 md:px-2">
        {service.features.slice(0, 3).map((feature, idx) => (
          <span
            key={idx}
            className="px-2 md:px-3 py-1 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 rounded-full text-xs font-medium border border-indigo-200"
          >
            {feature}
          </span>
        ))}
        {service.features.length > 3 && (
          <span className="px-2 md:px-3 py-1 bg-white text-gray-400 rounded-full text-xs border border-gray-200">
            +{service.features.length - 3}
          </span>
        )}
      </div>
      ...
      {/* Action Button */}
      <button
        className="w-[90%] mx-auto block mb-4 md:mb-6 px-3 py-2 md:py-3 rounded-lg md:rounded-xl text-sm md:text-base font-bold border-none cursor-pointer relative overflow-hidden transition-all duration-300"
        style={{
          background: isActive 
      ...
      >
        <span className="flex items-center justify-center gap-2 md:gap-3 relative z-10">
          ...
          <span className="inline-flex items-center justify-center w-6 h-6 md:w-7 md:h-7 rounded-full bg-white/20 text-white transition-all text-sm md:text-base">
            →
          </span>
        </span>
      </button>
  ...
  const SimulatorPanel: React.FC<{
    ...
    return (
      <div style={{
        ...
        <button
          onClick={onReset}
          className="absolute top-2 right-2 md:top-4 md:right-4 w-8 h-8 md:w-10 md:h-10 rounded-full bg-white border border-gray-300 cursor-pointer flex items-center justify-center text-gray-400 text-sm md:text-base font-bold transition-all duration-200 shadow-md z-10 hover:bg-gray-50 hover:text-gray-600 hover:shadow-lg"
        >
          ✕
        </button>
        
        {/* Header */}
        <div className="p-4 md:p-6 border-b border-gray-600 bg-gradient-to-r from-slate-800 to-gray-600 relative">
        ...
        {/* Content */}
        <div className="flex-1 p-4 md:p-6 overflow-y-auto bg-gray-900 text-white">
          {/* Selection Summary */}
      ...
      >
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mt-8 px-4">
          ...
          <div className="text-center mb-20">
            <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-3xl p-6 md:p-12 max-w-4xl mx-auto shadow-xl">
              ...
              <button
                ...
                className="relative overflow-hidden bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 text-white font-bold px-8 py-3 md:px-12 md:py-4 rounded-full text-base md:text-lg border-none cursor-pointer transition-all duration-300 transform scale-100 shadow-lg hover:scale-110 hover:shadow-xl"
              >
                <div className="relative flex items-center gap-2 md:gap-3 z-10">
                  <span>Start Your Transformation</span>
                  <div className="w-7 h-7 md:w-8 md:h-8 bg-white/20 rounded-full flex items-center justify-center transition-transform duration-300">
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl md:text-2xl font-bold">
                    {simulatorData[expandedService].title}
                  </h3>
                  <p className="text-indigo-100 mt-1">
                    {simulatorData[expandedService].description}
                  </p>
                </div>
                <button
