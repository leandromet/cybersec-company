...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed w-full top-0 z-50 transition-all duration-500 bg-white/95 backdrop-blur-md border-b border-neutral-200 shadow-sm ${
        scrolled ? "shadow-lg" : ""
      }`}
    >
